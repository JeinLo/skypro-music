...
Skypro-music — музыкальный сервис для прослушивания музыки с возможностью управления воспороизведением. Сервис выполнен на базе Next.js с использованием Redux.
